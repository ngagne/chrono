...
const reminder = `<chrono-self-improvement-reminder>
...
If yes: log it in .chrono/learnings/ and promote durable rules into AGENTS.md, .github/copilot-instructions.md, or /memories/repo.
</chrono-self-improvement-reminder>`;
