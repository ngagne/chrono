...
| Command | Purpose |
|---------|---------|
| `node ./scripts/helper.js` | [What it does] |
| `node ./scripts/validate.js` | [What it does] |
...
\`\`\`bash
node ./skills/skill-name/scripts/helper.js [args]
\`\`\`
...
| Script | Description |
|--------|-------------|
| `scripts/helper.js` | Main utility |
| `scripts/validate.js` | Validation checker |
